                ...
                <div className="container">
                    <div className="flex flex-wrap -mx-4">
                        ...
                        <div className="w-full sm:w-1/2 lg:w-3/12 md:px-4">
                            ...
                            {/* Follow our letters */}
                            <div className="px-4 -mx-4 border-gray-400">
                                <div className="max-w-xl mx-auto">
                                    <p className="text-gray-700 text-md pl-px">
                                    Join our newsletter and receive 10% off your first order.
                                    </p>
                                    <form action="#" className="mt-2">
                                        <div className="flex items-center">
                                            <input type="email" className="w-full  py-1 mr-2 border-black border-b focus:outline-none" required />
                                            <button className="font-bold  px-5 py-2 " >Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
